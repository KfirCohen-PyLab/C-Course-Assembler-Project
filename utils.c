...
boolean is_string(char *string)
{
    ...
    while (*string && !end_of_line(string)) { /* Goes until end of string */
        string++;
    }
	string--; /* at the end of the string must be '"', at the end of the line theres nothing */
